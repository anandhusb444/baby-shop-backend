...
namespace baby_shop_backend.Migrations
{
    ...
    [Migration("20241002143957_add-modelsRelationship")]
    partial class addmodelsRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("baby_shop_backend.Models.UserModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = "Admin",
                            isStatus = true,
                            password = "$2a$11$yiqu3B16lT27ge5OkdEZdeXCJ0NdMdL/qz3qH2H.wShQuJ3UrmHNS",
                            userEmail = "admin@.com",
                            userName = "Admin"
                        });
                });
