...
namespace baby_shop_backend.Migrations
{
    ...
    [Migration("20241004110513_AdDColumnInTheOrderItems")]
    partial class AdDColumnInTheOrderItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("baby_shop_backend.Models.UserModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = "Admin",
                            isStatus = true,
                            password = "$2a$11$LZsuct4Qy4iSAnybgazVxuPu.B5oKH.MLg9qkz/2608gI1SrDINoK",
                            userEmail = "admin@.com",
                            userName = "Admin"
                        });
                });
