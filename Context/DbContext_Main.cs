...
namespace baby_shop_backend.Context
{
    public class DbContext_Main : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(new User { id = 3, userName = "Admin", userEmail = "admin@123.com",password = BCrypt.Net.BCrypt.HashPassword("A12345678",salt),Role = "Admin",isStatus = true});
